...
<head>
    ...
    <title>Adullam - On Campus | RCN Bible Seminary</title>
            ...
            <div class="col-xl-6 col-12">
              <div class="about-box style-3">
                <ul class="block-list about-list">
                 <br>  <br>  <br> <br><div class="section-heading style-3">
             

			 <div class="sub-title">The On-campus option</div>
              <h2 class="title">On-Campus Program</h2>
            </div>
                  <li>
...
The On-Campus option is a full residency program. The academic activities has three requirements: a class attendance, a ministry practicum and Field Trip
<br><strong>Program Duration : 9 Months</strong>
                      </h5>
           <strong><h6><a href="handbook.pdf" target="_blank" >Download Student Handbok</a></h6></strong>
