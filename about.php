...
<head>
    ...
    <title>Adullam- About Us | RCN Bible Seminary </title>
  ...
  <body>
    ...
    <div id="wrapper" class="wrapper">
      ...
      <div
        ...
        data-bg-image="media/slide/5.png"
      >
      ...
      <section class="brand-wrap-style-1">
        <div class="container">
          ...
          <div class="inner-wrap" data-bg-image="media/elements/element12.png">
            <div class="row justify-content-center align-items-center">
             
            
        <h5>Adullam means Refuge or Justice of the people. It was mentioned eight (8) times in scriptures. The
Cave of Adullam stood on the old Roman road in the valley of Elah, not far from Gath, which was
the scene of David’s memorable victory over Goliath (1Samuel 17:2). <br>The Cave of Adullam became
a place of resort for David. It was the location where all that were stranded, discourage and had
given up on life resorted to David to find meaning (1Sam. 22:1-2). <br>Adullam became a forge where
